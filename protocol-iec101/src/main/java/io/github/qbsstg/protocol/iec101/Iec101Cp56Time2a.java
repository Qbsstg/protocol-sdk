...
public final class Iec101Cp56Time2a implements Iec101TimeTag {
    ...
    private Iec101Cp56Time2a(byte[] rawBytes, int millisecondsWithinMinute, int minute, int hour,
    ...
    public static Iec101Cp56Time2a parse(byte[] bytes, int offset) {
        ...
        return new Iec101Cp56Time2a(rawBytes, millisecondsWithinMinute, minute, hour, dayOfMonth,
